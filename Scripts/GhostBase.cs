...
public class GhostBase : MonoBehaviour
{
    ...
    public void ResetState()
    {
        ...
        if (isBlinky)
        {
            transform.position = LevelGenerator.GridToWorld(LevelData.HomeDoorPosition.x, -LevelData.HomeDoorPosition.y, LevelGenerator.GhostZLayer);
        }
        else
        {
            ResetPosition();
    ...
    public void ResetPosition() { 
        ...
        transform.position = LevelGenerator.GridToWorld(pos.x, -pos.y, LevelGenerator.GhostZLayer);
    }
}
